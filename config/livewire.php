...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'local'), // Keep local for now, simpler
        'rules' => null,                                      // Use default: ['required', 'file', 'max:12288'] (12MB)
        ...
        'preview_mimes' => [                                  // Supported file types for temporary pre-signed file URLs...
            ...
            'pdf', 'doc', 'docx',  // Added document types
        ],
        'max_upload_time' => 5, // Max duration (in minutes) before an upload is invalidated...
        'cleanup' => true, // Should cleanup temporary uploads older than 24 hrs...
        'domain' => env('APP_URL'), // Force use of APP_URL for ngrok compatibility
    ],
    ...
    */
    ...
    'payload' => [
        'max_size' => 30 * 1024 * 1024,   // 30MB - maximum request payload size in bytes (increased for large file uploads)
