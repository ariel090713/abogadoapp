...
class Consultations extends Component
{
    ...
    public function render()
    {
        ...
        $counts = [
            ...
            'payment_pending' => Consultation::forClient(auth()->id())->whereIn('status', ['payment_pending', 'payment_processing', 'payment_failed'])->count(),
    ...
    public function cancelConsultation()
    {
        ...
        if (!in_array($consultation->status, ['pending', 'payment_pending', 'payment_processing', 'payment_failed', 'scheduled', 'awaiting_quote_approval'])) {
