...
class RefundCompleted extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Refund Processed Successfully - AbogadoMo')
            ->greeting('Great news!')
            ...
            ->line('The refund has been credited back to your original payment method. Please allow 5-10 business days for the amount to reflect in your account.')
    ...
    public function toDatabase($notifiable): array
    {
        return [
            ...
            'message' => 'Your refund of ₱' . number_format($this->refund->refund_amount, 2) . ' has been processed successfully.',
