...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="px-6 pt-6 pb-4">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Request Reschedule</h3>
            <p class="text-sm text-gray-600 mb-4">Select a new date and time for your consultation</p>
            ...
            <div class="mt-4">
                ...
                @enderror
                <p class="text-xs text-gray-500 mt-1">Must be at least 24 hours from now</p>
            </div>
        ...
        <div class="px-6 py-4 bg-gray-50 flex gap-3 justify-end rounded-b-2xl">
            ...
            >
                ...
                <span wire:loading wire:target="requestReschedule" class="flex items-center justify-center gap-2">
                    <svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0 1 4 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
...
<!-- Decline Reschedule Modal (Lawyer Only) -->
@if($showDeclineRescheduleModal ?? false)
<div class="fixed inset-0 z-50 flex items-center justify-center p-4" style="background-color: rgba(0, 0, 0, 0.5);">
    <div class="bg-white rounded-2xl shadow-xl max-w-lg w-full">
        <div class="px-6 pt-6 pb-4">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Decline Reschedule Request</h3>
            <p class="text-sm text-gray-600 mb-4">Please provide a reason for declining</p>
        ...
        <div class="px-6 py-4 bg-gray-50 flex gap-3 justify-end rounded-b-2xl">
            <button 
                type="button"
                wire:click="$set('showDeclineRescheduleModal', false)"
                class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
            >
                Cancel
            </button>
            ...
            >
                ...
                <span wire:loading wire:target="declineReschedule" class="flex items-center justify-center gap-2">
                    <svg class="animate-spin h-4 w-4" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0 1 4 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
