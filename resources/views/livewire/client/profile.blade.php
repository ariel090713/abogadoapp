...
<div class="min-h-screen bg-white">
    <div class="mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-100 rounded-2xl p-4 sm:p-6 mb-6">
            <div class="flex items-start gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-600 rounded-xl flex items-center justify-center flex-shrink-0">
                    <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                    </svg>
                </div>
                <div class="flex-1 min-w-0">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Profile Information</h1>
        ...
        <!-- Navigation -->
        <x-profile-nav type="client" current="profile" />
        ...
        <form wire:submit="save" class="space-y-8">
                                ...
                                <div class="relative">
                                    @if($new_profile_photo)
                                        <img src="{{ $new_profile_photo->temporaryUrl() }}" 
                                             alt="Preview" 
                                             class="w-32 h-32 rounded-2xl object-cover border-4 border-primary-100">
                                    @elseif($profile_photo)
                                        <img src="{{ $profile_photo }}" 
                                             alt="{{ $name }}" 
                                             class="w-32 h-32 rounded-2xl object-cover border-4 border-primary-100">
                                    @else
                                        <div class="w-32 h-32 rounded-2xl bg-primary-100 flex items-center justify-center border-4 border-primary-200">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 sm:p-8 space-y-6">
                    <h3 class="text-lg font-semibold text-gray-900">Location & Languages</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                @foreach(\App\Helpers\Languages::getLanguages() as $lang)
                                    <label class="flex items-center gap-2 p-3 border rounded-lg cursor-pointer hover:bg-gray-50 transition {{ in_array($lang, $languages) ? 'bg-primary-50 border-primary-300' : 'border-gray-200' }}">
                                        <input 
                                            type="checkbox" 
