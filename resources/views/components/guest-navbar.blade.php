            ...
            <div class="hidden md:flex items-center gap-6">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    >
                        ...
                        <a href="{{ route('legal-guides') }}" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                    ...
                    >
                        ...
                        <a href="#" class="flex items-center gap-3 px-4 py-2.5 text-gray-700 hover:bg-gray-50 transition">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
