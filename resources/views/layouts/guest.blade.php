...
<head>
    ...
    <title>{{ config('app.name', 'AbogadoMo App') }}</title>
        ...
        <footer class="bg-gray-900 text-white py-12 md:py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            <svg class="w-7 h-7 md:w-8 md:h-8 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/>
                            </svg>
                            <span class="text-xl md:text-2xl font-bold">AbogadoMo</span>
                        </div>
                        <p class="text-gray-400 leading-relaxed text-sm md:text-base">Your trusted platform for online legal consultations in the Philippines</p>
                    </div>
                    <div>
                        <h3 class="font-bold text-base md:text-lg mb-3 md:mb-4">For Clients</h3>
                    ...
                    <div>
                        <h3 class="font-bold text-base md:text-lg mb-3 md:mb-4">For Lawyers</h3>
                        <ul class="space-y-2 md:space-y-3 text-gray-400 text-sm md:text-base">
                    ...
                    <div>
                        <h3 class="font-bold text-base md:text-lg mb-3 md:mb-4">Company</h3>
                        <ul class="space-y-2 md:space-y-3 text-gray-400 text-sm md:text-base">
                ...
                <div class="border-t border-gray-800 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-gray-400 text-sm md:text-base text-center md:text-left">&copy; {{ date('Y') }} AbogadoMo App. All rights reserved.</p>
